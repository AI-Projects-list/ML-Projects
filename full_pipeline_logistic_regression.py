"""
Complete ML Pipeline - Logistic Regression
===========================================
This script runs the entire ML pipeline for Logistic Regression from start to finish.
"""
...
def run_logistic_regression_pipeline():
    ...
    # ========== INITIALIZATION ==========
    print("\n" + "="*70)
    print("LOGISTIC REGRESSION - COMPLETE ML PIPELINE")
    print("="*70 + "\n")
    ...
    # Save processed data
    processed_path = Path("data/processed/logistic_regression_data.pkl")
    ...
    logger.info(f"✓ Model trained: Logistic Regression")
    ...
    predictions_path = Path("outputs/logistic_regression/predictions.csv")
