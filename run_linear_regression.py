"""Linear Regression Model - Complete Pipeline."""
...
def main() -> None:
    """Run Linear Regression pipeline."""
    # Initialize
    ...
    logger.info("=" * 60)
    logger.info("LINEAR REGRESSION MODEL PIPELINE")
    logger.info("=" * 60)
    
    # Data source - use regression dataset
    source = DataSource(
        source_type=DataSourceType.CSV,
        path="data/raw/sample_regression.csv",
    ...
    results = pipeline.execute(
        ...
        model_output_path=Path("models/linear_regression_model.pkl"),
    )
    ...
    logger.info("=" * 60)
    logger.info(f"Model Type: Linear Regression")
    ...
    logger.info(f"Model saved to: models/linear_regression_model.pkl")
    logger.info("=" * 60)
