"""
Complete ML Pipeline - Random Forest
=====================================
This script runs the entire ML pipeline for Random Forest from start to finish.
"""
...
def run_random_forest_pipeline():
    ...
    # ========== INITIALIZATION ==========
    print("\n" + "="*70)
    print("RANDOM FOREST - COMPLETE ML PIPELINE")
    print("="*70 + "\n")
    ...
    # Save processed data
    processed_path = Path("data/processed/random_forest_data.pkl")
    ...
    eda_output_dir = Path("outputs/random_forest/eda")
    ...
    logger.info(f"✓ Model trained: Random Forest")
    ...
    predictions_path = Path("outputs/random_forest/predictions.csv")
    ...
    print(f"Number of Trees: {model_config.hyperparameters.get('n_estimators', 100)}")
