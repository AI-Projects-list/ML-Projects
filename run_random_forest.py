"""Random Forest Model - Complete Pipeline."""
...
def main() -> None:
    ...
    logger.info("=" * 60)
    logger.info("RANDOM FOREST MODEL PIPELINE")
    logger.info("=" * 60)
    ...
    results = pipeline.execute(
        ...
        model_output_path=Path("models/random_forest_model.pkl"),
    )
    ...
    logger.info("=" * 60)
    logger.info(f"Model Type: Random Forest")
    ...
    logger.info(f"Model saved to: models/random_forest_model.pkl")
    logger.info("=" * 60)
